...
export default function Dashboard() {
  return (
    <DashboardShell>
      <DashboardHeader heading="Trading Bot Dashboard" text="Monitor your bot's performance and trading activities" />
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-3">
          <CardHeader>
            ...
            <CardDescription>Your bot executed 12 trades today</CardDescription>
          </CardHeader>
          <CardContent>
            <Overview />
          </CardContent>
