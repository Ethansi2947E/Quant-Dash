    ...
    <div className="container space-y-4 py-4 px-4 md:py-8">
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-xl md:text-2xl font-bold text-emerald-500">+$2,350.25</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl md:text-2xl font-bold">68.2%</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-xl md:text-2xl font-bold">$24,563.82</div>
